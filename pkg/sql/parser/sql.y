...
%token <str> STABLE START STATE STATEMENT STATISTICS STATUS STDIN STDOUT STOP STRAIGHT STREAM STRICT STRING STORAGE STORE STORED STORING SUBJECT SUBSCRIBE SUBSCRIPTION SUBSTRING SUPER
%token <str> SUPPORT SURVIVE SURVIVAL SYMMETRIC SYNTAX SYSTEM SQRT STATEMENTS
...
%token <str> UNBOUNDED UNCOMMITTED UNIDIRECTIONAL UNION UNIQUE UNKNOWN UNLISTEN UNLOGGED UNSAFE_RESTORE_INCOMPATIBLE_VERSION UNSUBSCRIBE UNSPLIT
...
%type <tree.Statement> subscribe_stmt
%type <tree.Statement> unsubscribe_stmt
...
// %Help: SUBSCRIBE - subscribe to query results
// %Category: Misc
// %Text: SUBSCRIBE TO <select_stmt>
subscribe_stmt:
  SUBSCRIBE TO select_stmt
  {
    $$.val = &tree.Subscribe{Query: $3.slct().Select}
  }
| SUBSCRIBE error // SHOW HELP: SUBSCRIBE

// %Help: UNSUBSCRIBE - unsubscribe from query results
// %Category: Misc
// %Text: UNSUBSCRIBE <subscription_id>
unsubscribe_stmt:
  UNSUBSCRIBE a_expr
  {
